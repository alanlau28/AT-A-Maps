...
void help_button_callback() {
    ...
    "'and' or '&' in the search bar \n"
    "After click the 'Find Intersections of Two Streets' button \n"
    "and the intersection will be highlighted.\n\n"
    ...
    "path from one intersection to the other. After searching\n"
    "a list of step-by-step directions will be\n"
    ...
    "directions written at the top left of the map.\n\n"
